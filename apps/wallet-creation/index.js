...
let argv = parseArgs(process.argv.slice(2), {default: {"endpoint": "ws://127.0.0.1:8546", "registry": "0x49307b9867f4e1C48c40f9563c96627390307CF2", "maxTxValue": 1, "minBlockDistance": 5}});

let web3 = new Web3(argv["endpoint"]);
...
async function createWallet(sender, keycard, maxTxValue, minBlockDistance) {
    ...
    .then(function(gasAmount){
        methodCall.send({from: sender, gas: gasAmount}).then(function(receipt) {
            console.log("tx sent");
...
async function run() {
    ...
    createWallet(sender, "0x3bea1293f03bbcacd53bec3f45cf55e448b5afae", argv["maxTxValue"], argv["minBlockDistance"]);
}
